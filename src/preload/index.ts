...
const api: HauserBacklogApi = {
  ...
  searchPurchaseOrder: (request) => ipcRenderer.invoke(IPC_CHANNELS.searchPurchaseOrder, request),
  prepareBacklogPrint: (request) => ipcRenderer.invoke(IPC_CHANNELS.prepareBacklogPrint, request),
  saveBacklogPdf: (request) => ipcRenderer.invoke(IPC_CHANNELS.saveBacklogPdf, request),
  ...
  getWorkOrderPainted: (request) => ipcRenderer.invoke(IPC_CHANNELS.getWorkOrderPainted, request),
